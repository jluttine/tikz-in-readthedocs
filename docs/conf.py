# -*- coding: utf-8 -*-
#
# TikZ in Read the Docs documentation build configuration file, created by
...
# Add a path to binary executable and library files that are necessary
# for readthedocs.org to build HTML with TikZ extension
...
htmlhelp_basename = 'TikZinReadtheDocsdoc'
